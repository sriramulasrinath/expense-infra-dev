resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-srinath.online
  ...
  aliases = ["web-${var.common_tags.component}.${var.zone_name}"]#web-cdn.srinath.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.srinath.online
      type    = "A"
